...
$id_UKM = $_GET['ukm'];
$qrySelect = mysql_query("select * from tbl_ukm where id_ukm = '$id_UKM'");
$h = mysql_fetch_array($qrySelect);
    ...
    <div class="row">
        <div class="col-lg-12">
			...
			if (isset($_POST['tambah'])){
				$qrSimpan = mysql_query("update tbl_ukm set nama_ukm = '$judul', alamat_ukm = '$alamat', pengelola_ukm = '$pengelola', ket_ukm = '$ket' 
										 where id_ukm = '$id_UKM'");
				if ($qrSimpan){
					?>
					<script>
                    ...
                    <form  name="frmUKM"  method="post" action="" onsubmit="return cek();" enctype="multipart/form-data">                        
                        <table width="70%" border="0">
                          ...
                          <tr style="margin:0px 0px 0px 0px;">
                            ...
                            <td width="68%">
                            	<textarea id="txtAlamatUKM" name="txtAlamatUKM" placeholder="Masukkan Alamat UKM" class="form-control" style="height:100px;"><?php echo $h['2']; ?></textarea>
                            </td>
                          </tr>
                          <tr style="margin:0px 0px 0px 0px;">
                            ...
                            <td width="2%" style="vertical-align:top;">:</td>
                            <td width="68%">
                            	<textarea id="txtKetUKM" name="txtKetUKM" placeholder="Masukkan Keterangan Untuk UKM baru" class="form-control" style="height:100px;"><?php echo $h['4']; ?></textarea>
                            </td>
                          </tr>
                        </table>
                        <br />
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary btn-sm btn-rect" onclick="javascript: window.location.href='ukm.html'">
