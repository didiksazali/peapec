...
$qrySelect = mysql_query("select * from tbl_kategori where id_kategori = '$id_kategori'");
$r = mysql_fetch_array($qrySelect);
...
?>
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php
			if (isset($_POST['edit'])){
				$qrSimpan = mysql_query("update tbl_kategori set nama_kategori = '$judul', ket_kategori = '$ket' where id_kategori = '$id_kategori'");
				if ($qrSimpan){
					?>
					<script>
                    ...
                    <form  name="frmKategori"  method="post" action="" onsubmit="return cek();" enctype="multipart/form-data">                        
                        <table width="70%" border="0">
                          ...
                          <tr style="margin:0px 0px 0px 0px;">
                            ...
                            <td width="68%">
                            	<textarea id="txtKetKategori" name="txtKetKategori" placeholder="Masukkan Keterangan Untuk Kategori baru" class="form-control" style="height:100px;"><?php echo $r['2']; ?></textarea>
                            </td>
                          </tr>
                        </table>
                        <br />
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary btn-sm btn-rect" onclick="javascript: window.location.href='<?php echo "kategori.html";?>'">
                                <i class="glyphicon glyphicon-remove"></i> Batal
                            </button>
                            <button type="submit" name="edit" class="btn btn-primary btn-sm btn-rect">
