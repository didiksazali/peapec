...
//Simpan gambar
imagejpeg($im,$vdir_upload . "galeri_" . $img_name);
...
//Fungsi untuk meng-upload gambar
function UploadSlider($img_name, $lokasiGambar){
...
//Simpan gambar
imagejpeg($im,$vdir_upload . "slider_" . $img_name);

unlink("../images/slider/".$img_name);
